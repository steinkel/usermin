<div class="umroles index">
	<h2><?php echo __('Umroles');?></h2>
	...
	<?php
	$i = 0;
	foreach ($umroles as $umrole): ?>
	<tr>
		<td><?php echo h($umrole['Umrole']['id']); ?>&nbsp;</td>
		<td><?php echo h($umrole['Umrole']['name']); ?>&nbsp;</td>
		<td><?php echo h($umrole['Umrole']['rank']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $umrole['Umrole']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $umrole['Umrole']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $umrole['Umrole']['id']), null, __('Are you sure you want to delete # %s?', $umrole['Umrole']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
